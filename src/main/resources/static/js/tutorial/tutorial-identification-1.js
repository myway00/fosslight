...
$(document).ready(function (){
    ...
    // 하이라이트할 요소들의 배열
    let array_highlights = [$button1, $button2, $button3, $button5, $button6, $button7, $button8];
    
    // 툴팁이 보여줄 제목 및 내용의 배열
    let array_tooltip_data = [
        { title: "upload", content: "OSS List가 쓰여진 Sample FOSSLight Report(https://fosslight.org/fosslight-guide/tutorial/result_files/sample_src.tar.gz)를 다운로드 후, Upload 합니다. 이때 Load 할 Sheet로 SRC Sheet를 선택합니다." },
