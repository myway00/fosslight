$(document).ready(function (){
        ...
        let array_highlights = [$button1, $button2, $button3];//, $button3, $button4, $button5
        // 툴팁이 보여줄 제목 및 내용의 배열
        let array_tooltip_data = [
          { title: "project save", content: "Project 정보를 입력한 후 Save button 을 클릭합니다." },
          { title: "new project", content: "add 후 새 프로젝트가 생성된 것을 확인합니다." },
          { title: "identification", content: "Identification Column 내 Start 버튼을 클릭합니다" }
        ];
